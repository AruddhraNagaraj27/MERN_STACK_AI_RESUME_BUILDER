  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        >
          <ArrowLeftIcon className="size-4 m-4 cursor-pointer hover:opacity-70" />
          Back to Dashboard
        </Link>
      </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              {/* Section navigation */}
              <div className="flex justify-betwen items-center mb-6 border-b border-gray-300 py-1">
                  ...
                  <TemplateSelector
                    ...
                    onChange={(templateId) =>
                      setResumeData(prev => ({
                        ...prev,
                        template: templateId,
                        accent_color: templateColors[templateId] || "#3B82F6"
                      }))
                    }
                  />

...
const handleEnhanceDescription = async (index) => {
  ...
  if (!description.trim()) {
    toast.error('Please write a description before enhancing');
    return;
  }
...
{/* Header */} <div className="flex items-center justify-between"> <div> <h3 className="flex items-center gap-2 text-lg font-semibold text-gray-900">
Professional Experience </h3> <p className="text-sm text-gray-500">
Add your job experience here </p> </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <input
              ...
              className="px-3 py-2 border border-gray-300 text-sm rounded-lg focus:ring-2 focus:ring-purple-500"
            />
            ...
            <input
              ...
              className="px-3 py-2 border border-gray-300 text-sm rounded-lg disabled:bg-gray-100 focus:ring-2 focus:ring-purple-500"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full text-sm px-3 py-2 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-purple-500"
